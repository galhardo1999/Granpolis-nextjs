  ...
  return (
    <div style={{ color: '#e2d5b0', fontFamily: 'var(--font-body, Arial)' }}>
      <div style={{
        ...
        <h4 style={{ color: '#ef4444', margin: '0 0 6px', fontSize: '1rem' }}>⚔️ Atacar Aldeia Bárbara</h4>
        <p style={{ color: '#9aa0ac', margin: 0, fontSize: '0.85rem' }}>
          Selecione suas tropas e conquiste recursos de aldeias desprotegidas.
        </p>
      </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            {ultimoRelatorio.relatorio.map((linha, i) => (
              <p key={i} style={{ margin: 0, color: '#e2d5b0', fontSize: '0.88rem' }}>{linha}</p>
            ))}
          </div>
